    ...
    <div>
      ...
      <div className="p-10 flex items-center justify-center ">
        <div className=" p-1  border-double border-[10px] border-green-600 lg:w-[80%] grid grid-cols-2 gap-4 sm:grid-cols-4   ">
          {arrayimgs.map((src, index) => (
            <img layout="fill" key={index} className="rounded-[0.5rem] hover:scale-[160%] lg:hover:scale-[200%]  hover:border-2 hover:border-green-600 " src={src} alt="" />
          ))}
        </div>
      </div>
      <Footer />
