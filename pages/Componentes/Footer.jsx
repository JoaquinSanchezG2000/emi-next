  ...
  return (
    <div className=" w-full bg-green-600 flex items-center justify-around lg:mt-[8rem] mt-[15rem]">
      ...
      <div className=" h-full w-[20%] lg:w-[50%]  mr-6 flex items-center ">
        <Image layout="fill" className="w-[4rem] h-[50%] " src="/Images/logo.png" alt="" />
      ...
      >
        ...
        <div className="flex items-center justify-around w-full">
          <a href="">
            <Image layout="fill" className="w-[4rem] " src="/Images/instagram.png" alt="" />
          </a>

          <a href="https://wa.link/xnuwu0 " rel="noreferrer" className="border-3 ">
            <Image layout="fill" className="w-[4rem] " src="/Images/whatsapp.png" alt="" />
          </a>
          <a href="">
            {" "}
            <Image layout="fill" className="w-[4rem] " src="/Images/mercadoLogo.png" alt="" />
          </a>
          <a href="">
            <Image layout="fill" className="w-[4rem] " src="/Images/email.png" alt="" />
          </a>
        </div>
      </div>
    </div>
