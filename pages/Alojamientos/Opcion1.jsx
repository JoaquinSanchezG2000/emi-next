    ...
    <div>
      ...
      <div className="flex flex-col lg:flex-row w-full items-center  lg:mt-10 justify-around">
        ...
        <div className="w-[80%] mt-[1rem] lg:w-[35%]     ">
          ...
          <p className="mt-5">
            Cabaña2 Lorem ipsum dolor sit amet consectetur, adipisicing elit. Asperiores unde animi
            ea mollitia possimus natus expedita. Sit reprehenderit nostrum eaque soluta fuga tempore
